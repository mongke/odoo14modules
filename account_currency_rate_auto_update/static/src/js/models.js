odoo.define('pos_fast_load.models', function (require) {
"use strict";
...
models.PosModel = models.PosModel.extend({
    load_server_data: function () {
        ...
        return posmodel_super.load_server_data.apply(this, arguments).then(function () {
            ...
            var config_id = self.pos_session.config_id[0],
                records = new Model('pos.config').call('get_pos_cache',
                    [config_id, product_fields, product_domain]);
